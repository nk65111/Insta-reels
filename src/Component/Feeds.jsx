    ...
    return ( 
        <>
            ...
            <div className="upload-file">
                <label>
                <Button variant="contained" color="secondary" component="label" style={{margin:"5px"}}>Select File<input type="file" onChange={handlefileInput} hidden/></Button>
                <Button variant="contained" color="secondary" onClick={handleOnUpload} startIcon={<PhotoCamera></PhotoCamera>}>Upload</Button>
